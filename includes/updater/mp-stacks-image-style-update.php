<?php
/**
 * This file contains the function keeps the MP Stacks + Image Style plugin up to date.
 *
 * @since 1.0.0
 *
 * @package    MP Stacks + Image Style
 ...
 * @return   void
 */
 if (!function_exists('mp_stacks_image_style_update')){
	function mp_stacks_image_style_update() {
		$args = array(
		...
		$mp_stacks_image_style_plugin_updater = new MP_CORE_Plugin_Updater($args);
	}
 }
add_action( 'init', 'mp_stacks_image_style_update' );
